    ...
    return (
        <div className=" container pt-10 lg:pt-14 2xl:pt-20">
            <div className=" grid grid-cols-4 gap-6 xl:gap-0 mb-10">
                <div className=" col-span-4 lg:col-span-1 lg:border-r-2">
                ...
                <div className=" col-span-4 lg:col-span-3 xl:pl-10 2xl:pl-20">
                    <div className="py-6 lg:p-10">
                        <h4 className="text-[#4c5967]">Send us a massage.</h4>
                        <p>
                            If you prefer, you can also use the form below to
                            send us a message. We will get back to you as soon
                            as possible.
                        </p>
                        <form
                            method="POST"
