  ...
  return (
    <>
      <Button
        ...
        size="sm"
      >
        <NotePencil size={20} strokeWidth={2} className="h-4 w-4" /> Add Notice
      </Button>
      ...
      >
        ...
        <div className=" py-10">
          <form action="" method="post" onSubmit={(e) => submitHandler(e)}>
            ...
            <div className=" w-full flex justify-around pt-12 gap-6">
              <button
                onClick={handleOpen}
                className=" px-5 py-2 border-2 border-green-500 text-green-500 rounded-md"
              >
                Cancel
              </button>
              <SubmitBtn
