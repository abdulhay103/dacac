      ...
      <div className="container">
        <div className=" grid grid-flow-row lg:grid-flow-col grid-cols-12 gap-6 lg:gap-16 2xl:gap-20">
          <div className="col-span-12 lg:col-span-8">
            <div className="">
              <h4>{data.title}</h4>
              <p className=" py-6 text-justify">{data.short_desc}</p>
              <div className=" py-6">
                <Image
                  src={data.image}
                  width="1000"
              ...
              <div>
                <p>
                  <span className=" pr-3 font-bold">Author:</span>
                  {data.users["firstName"] + " " + data.users["lastName"]}
                </p>
                <p>
                  <span className=" pr-3 font-bold">Post Published:</span>
              ...
              <div className=" grid grid-cols-12 gap-6 lg:gap-10 2xl:gap-14 py-8 -skew-x-6">
                {relatedBlogs.map((item) => (
                  ...
                  >
                    ...
                    <p className=" py-3 font-bold">{item.title}</p>
                  </Link>
                ))}
              </div>
            </div>
