...
export default function UpdateProduct(props) {
    ...
    const [inputValues, setInputValues] = useState({
        ...
        support_n_care: productDetails.support_n_care,
        how_to_setup: productDetails.how_to_setup,
    ...
    let submitVales = {
        ...
        details: editorValue === "" ? productDetails.details : editorValue,
        img1: imgUrl1 === "" ? productDetails.img1 : imgUrl1,
        img2: imgUrl2 === "" ? productDetails.img2 : imgUrl2,
        img3: imgUrl3 === "" ? productDetails.img3 : imgUrl3,
        ...
        >
            ...
            <div className=" w-full py-2">
                ...
                <ReactQuill
                    theme="snow"
                    value={
                        editorValue === "" ? inputValues.details : editorValue
                    }
            ...
            <div className="flex gap-6 py-2">
                <div className=" w-full">
                    ...
                    <input
                        onChange={(e) =>
                            onChangeHandler("origin", e.target.value)
                        }
                ...
                <div className=" w-full">
                    ...
                    <input
                        onChange={(e) =>
                            onChangeHandler("discount", e.target.value)
                        }
            ...
            <div className="flex gap-6 py-2">
                <div className=" w-full">
                    <label htmlFor="support_n_care">Support and Care</label>
                    <textarea
                        onChange={(e) =>
                            onChangeHandler("support_n_care", e.target.value)
                        }
                        value={inputValues.support_n_care}
                        type="text"
                        name="support_n_care"
                        id="support_n_care"
                        rows="3"
                ...
                <div className=" w-full">
                    <label htmlFor="how_to_setup">How to setup</label>
                    <textarea
                        onChange={(e) =>
                            onChangeHandler("how_to_setup", e.target.value)
                        }
                        value={inputValues.how_to_setup}
                        type="text"
                        name="how_to_setup"
                        id="how_to_setup"
                        rows="3"
            ...
            <div className="flex gap-6 py-2 items-center">
                <div className=" w-full">
                    ...
                    <textarea
                        onChange={(e) => onChangeHandler("faq", e.target.value)}
                        value={inputValues.faq}
                        type="text"
                        name="faq"
                        id="faq"
                        rows="3"
                ...
                <div className=" w-full">
                    <Select
                        ...
                        onChange={(e) => onChangeHandler("categoryId", e)}
                    >
                        {categories?.map((item) => (
