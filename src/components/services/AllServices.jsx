    ...
    <div className=" container py-10">
      <div className="grid grid-flow-row grid-cols-12 services-center gap-8 lg:gap-10 xl:gap-12 py-10 lg:py-12 xl:py-16 2xl:py-20">
        {services.map((service) => (
          <div
            key={service.id}
            className=" p-5 lg:p-6 col-span-12 lg:col-span-4 gap-6 lg:gap-8 xl:gap-10 min-h-[430px] border rounded-md bg-white shadow-lg hover:shadow-xl hover:border-deep-orange-500 hover:scale-105 transition-all duration-500"
          >
            ...
            <div className=" flex justify-center py-5">
              <CtaBtn href={`/services/${service.id}`} text="Read More" />
            </div>
          </div>
        ))}
      </div>
