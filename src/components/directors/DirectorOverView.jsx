...
const TABLE_HEAD = ["Image", "Derector", "Designation", "Last Update", ""];

export default function DirectorOverView({ data, itemsPerPage }) {
    ...
    <Card className="h-full w-full mt-5">
        ...
        <div className="flex items-center justify-between gap-8 pt-4 px-6">
          <div>
            <Typography variant="h5" color="blue-gray">
              Our Directors Over View
            </Typography>
            <Typography color="gray" className="mt-1 font-normal">
              See all directors details.
            </Typography>
          </div>
      ...
      <CardBody className=" overflow-y-auto px-0">
        <table className="mt-4 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {currentData.map(
              ({ id, name, designation, img, updatedAt }, index) => {
                  ...
                  <tr key={id}>
                    ...
                    <td className={classes}>
                      <div className=" flex gap-4">
                        <Link href={`/dashboard/directors/${id}`}>
